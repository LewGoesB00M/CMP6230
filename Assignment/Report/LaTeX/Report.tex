...
%
% VITAL IMPORTANCE! WHEN YOU WRITE YOUR CODE FOR MARIADB/REDIS, YOU MIGHT NEED TO MAKE A NEW VM.
% YOUR CURRENT VMs USE THE USERNAME "LEWIS" AND PASSWORD "VBOX", BUT THAT'S NOT HOW HER VM WILL BE 
% SETUP FOR THE ASSESSMENT OF YOUR CODE (if she actually does assess the code? maybe it's just the report because you do need to show it working anyway). 
% YOU MAY INSTEAD NEED "STUDENT" AND "PASSWORD", THOUGH MARIADB FORBIDS THE USE OF "PASSWORD".
%

% There's an extreme alternative that you have considered before.
% Convert your PC into a dual-boot Linux/Windows system, though it wouldn't solve the Student:Password problem
% nor do I know how you'd share files.
