...
in the Model API script using FastAPI. Through running the server as detailed in Figure 
\ref{fig:UviStartup}, the "docs" page of FastAPI can be accessed to manually perform POST 
requests to get predictions from the model. 

\para It is important to note that the use of the "docs" page is not suitable for an actual production 
...
indicating an ordinal type that was originally misidentified.
...
% While you could submit and proofread on that day, do not plan around leaving it until then.
% =========================================================================
\include{AppendixA}
