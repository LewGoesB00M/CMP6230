...
the decision of which order to use can be determined from the data itself, with datasets that will need 
...
\begin{longtable}{ |p{0.2\textwidth}| p{0.5\textwidth}|}
    ...
    \hline
    Great Expectations &
    Will be used to validate that imported data is of the correct format and will not cause 
