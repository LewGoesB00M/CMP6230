...
\begin{longtable}{ |p{0.2\textwidth}| p{0.8\textwidth}|}
    ...
    \hline
    Pickle &
    A base package in Python that functions similarly to Arrow in the serialization of data. Pickle
    specifically is used to serialize machine learning models.\\
    \hline
    Great Expectations &
