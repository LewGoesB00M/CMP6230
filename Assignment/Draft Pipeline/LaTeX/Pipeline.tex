...
% This report aims to design and document a five-stage Machine Learning Operations pipeline, beginning 
% with the identification of three candidate datasets for the pipeline to be conducted with, and continuing 
% into descriptions of each stage of the pipeline and how it will be implemented with the one chosen dataset.

% I literally wrote that myself but it just reads like AI so I can't really include it. Such bullshit
...
\pagebreak % Seperating Fig 2.3 from preprocessing section.
